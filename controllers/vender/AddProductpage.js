      ...
      let postedit = async (req, res) => {
        try {
            ...
            if (!productname || !description) {
                return res.status(400).json({ success: false, message: 'Incomplete data for product update' });
            }
...
module.exports={postedit,geteditProduct, productDelete,getDelete,getpostProductAdd,getproductAdd,getproductDetails};